...
​		除了标注“需配置快捷键”的，其他的都是按照系统默认快捷键设置的。这些都是我用着还比较顺手的，如果想要换成其他的按键，建议查看json文件并修改。



​		由于其中一些按键默认是没有的，所以要在下图这里自己配置，注意名字要与系统显示的一致才可以生效![image](https://github.com/Whosydd/Karabiner_Rules/blob/master/images/README/%E6%88%AA%E5%B1%8F2020-10-23%2011.47.25.png)
